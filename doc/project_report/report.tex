...
\\
Specific to FARS2021National we choose the variables speeding, driving without a valid license and driving under the influence to constitute preventable human error. Figure \ref{fig:err-case-counts} illustrates the respective variables, their number of occurrences and their overlap.

\begin{figure}[ht]
	\vskip 0.2in
	\begin{center}
		\centerline{\includegraphics[width=0.66\columnwidth]{placeholder}}
		\caption{Case counts for the three variables we consider as preventable human error in FARS2021National.}
...
Figure \ref{fig:occurence} shows that preventable human error has an overall high incidence in the dataset. This statistic in and of itself urges \ldots
...
\begin{figure}[ht]
	...
	\centering
		\begin{subfigure}[ht]{0.45\columnwidth}
			...
			\caption{The occurence of the variables and their values we consider preventable human error as a percentage of all drivers.}
			\label{prevalence-per-variable}
		\end{subfigure}
		\hfill
		\begin{subfigure}[ht]{0.45\columnwidth}
			\includegraphics[width=\columnwidth]{placeholder}
			\caption{Number of drivers subject to preventable human error grouped by variable.}
...
\begin{figure}[ht]
	...
	\begin{center}
		...
		\caption{Correlation of preventable human error with age and sex as a percentage of the total set of drivers. The male population is displayed on the left and the female population on the right. The minimal legal driving age of !? source, reference ?! is located right inbetween ? the second and third ? bins.}
...
\begin{figure}[ht]
	...
	\centering
		...
		\end{subfigure}
	\caption{The correlation of time of day in hours with preventable human error as a \ldots}
	\label{fig:err-time}
	\vskip 0.2in
\end{figure}

A closer look at how time correlates with occurrence of preventable human error ? plot ?
