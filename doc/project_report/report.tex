...
\\
FARS2021National includes several records wherewhere the value of one or more of these variables is missing. Specifically, there were X driver records that didn't state the speed at the time of the accident, X records not including information about the license and X records not specifying whether the driver was drinking ? ADD NUMBERS ?\\
