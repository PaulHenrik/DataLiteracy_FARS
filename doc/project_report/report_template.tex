...
\\
In this work, we introduce a new data-driven definition of such human error, allowing us to differentiate these human errors from those that may be consequences of the distinct challenges of the driving scenario \citep{guanetti2018control}. We base our definition on the FARS2021National dataset of fatal traffic accidents in the United States of America and analyse the occurence of human error within it. 
\\
Our results show an overall high occurence of cases involving human errors in the United States. We also observe a strong correlation of human error occurrence with !certain! driver demographics and accident conditions.
\\
...
To reduce the inherent ambiguity, we must first come to a strict definition of what human error is. In this work, our goal is to make a selection of variables representing unnecessary risk factors that are specific to human beings.
To analyse human error, we 
...
\begin{figure}[ht]
	...
	\centering
		...
		\hfill
		\begin{subfigure}[ht]{0.45\columnwidth}
			\includegraphics[width=\columnwidth]{prevalence-multiple-occurence}
